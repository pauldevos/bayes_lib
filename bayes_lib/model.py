...
"""
Standard paramterized probabilitymModel that allows for computation
of a log density of the given parameters and data
"""
class Model(Context):
...
"""
Probability model that does not allow for the computation of a log density but
only simulation of data
"""
class SimulationModel(Context):
