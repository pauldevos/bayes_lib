...
class BlackBoxVariationalInference(VariationalInference):
    ...
    def run(self, n_mc_samples = 200, n_grad_samples = 200, optimizer = GradientDescent(learning_rate = 1e-5), iter_func = None, iter_interval = 1, max_opt_iters = 1000, convergence = 1e-4):
...
class ReparameterizedVariationalInference(VariationalInference):
    ...
    def run(self, n_mc_samples = 10, n_grad_samples = 10, optimizer = GradientDescent(learning_rate = 1e-4), iter_func = None, iter_interval = 1, max_opt_iters = 1000, convergence = 1e-3):
